...
class HardNegativeMixup():
    ...
    def mixup(self, feats, labels):
        ...
        for i in range(self.n_synthetic):
            ...
            # mix the anchor with the hard negative samples
            # get the two negative samples
            neg_sample = feats[hard_neg_idx[i]]
            synthetic_sample = self.alpha * neg_sample + (1 - self.alpha) * anchor
        ...
        # the synthetic samples are labeled as 0 - spoof
